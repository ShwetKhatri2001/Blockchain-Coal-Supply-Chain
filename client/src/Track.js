...
function Track() {
    ...
    return (
      <div className="container-xl">
        <button
          ...
          className="btn btn-outline-success btn-sm my-3"
        >
          Track Another Order
        </button>
        <span
        ...
        <section className="row">
          <article className="col-12">
            <h4>
              <u>Electricity Order Accepted by ( Power Plant ):</u>
            </h4>
            <p>
              <b>Power Plant ID: </b>
              {RMS[MED[ID].RMSid].id}
          ...
          <article className="col-12">
            <h4>
              <u>Regulated by ( Authority taking place ):</u>
            </h4>
            <p>
              <b>Regulatory Authority ID: </b>
              {DIS[MED[ID].DISid].id}
            </p>
            <p>
    ...
    return (
      <div className="container-xl">
        ...
        <section className="row">
          <article className="col-12">
            <h4>
              <u>Electricity Order Accepted by ( Powerplant ):</u>
            </h4>
            <p>
              <b>Power Plant ID: </b>
              {RMS[MED[ID].RMSid].id}
  ...
  const handlerSubmit = async (event) => {
    ...
    if (!(ID > 0 && ID <= ctr)) alert("Invalid Order ID!!!");
    else {
    ...
    <div className="m-3">
      ...
      <table className="table table-bordered mt-3">
        {Object.keys(MED)?.length > 0 ? (
          ...
          <h4 className="mt-3">Add Orders to track</h4>
        )}
        <tbody>
      ...
      {Object.keys(MED)?.length > 0 && (
        <>
          <h4>Enter Order ID to track it</h4>
