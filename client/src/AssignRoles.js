...
function AssignRoles() {
  ...
  return (
    <div className="m-3">
      ...
      <h4 className="mt-3">Thermal Power Plant:</h4>
      <form onSubmit={handlerSubmitRMS}>
        ...
        <input
          ...
          placeholder="Thermal Power Plant Name"
          required
        />
        <input
          className="form-control-sm"
      ...
      <hr />
      <h4 className="mt-5">Coal Miner:</h4>
      ...
      <hr />
      <h4 className="mt-5">Regulatory Authority:</h4>
      ...
      <hr />
      <h4 className="mt-5">Transporter:</h4>
